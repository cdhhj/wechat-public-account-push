export const config = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: "wxcdac4c2dd4ff1b19",

  // 公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: "841ee35fc51217cea7516411c741efd8",
   ...
   */
  USERS: [omG8j5520XgoR9u6vmy29On5Ri8w
    {
      // 想要发送的人的名字
      name: "妮子",
      ...
      festivals: [
        ...
        {"type": "*生日", "name": "妮子", "year": "2003", "date": "01-03"},
        {"type": "节日", "name": "相识", "year": "2022", "date": "07-29"},
  ...
  CALLBACK_TEMPLATE_ID: "1c6UbkcqeJfTud4lmcvTJrh3UIEJ1BALgkrp6LY3voE",

  // 接收成功回调消息的微信号，（一般来说只填自己的微信号, name填不填无所谓）
  CALLBACK_USERS: [ YsL-09-17
    {
      // 一般都填自己
      name: "自己",
